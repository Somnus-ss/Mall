<template>
  <tab-bar>
    ...
    <!--          <img src="./assets/img/tabbar/class.svg" alt="">-->
    <!--          <img slot="item-icon-active" src="./assets/img/tabbar/class-active.svg" alt="">-->
    <!--        </template>-->
    ...
    <tab-bar-item path="/cart" activeColor="blue">
      ...
      <img slot="item-icon-active" src="~assets/img/tabbar/car-active.svg" alt="">
